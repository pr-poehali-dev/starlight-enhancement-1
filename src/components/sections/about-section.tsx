      ...
      <div className="mx-auto w-full max-w-7xl">
        <div className="grid gap-8 md:grid-cols-2 md:gap-16 lg:gap-24">
          <div>
            ...
            >
              <h2 className="mb-3 font-sans text-3xl font-light leading-[1.1] tracking-tight text-foreground md:mb-4 md:text-6xl lg:text-7xl">
                ...
                в полную
                <br />
                <span className="text-foreground/40">силу</span>
              </h2>
            </div>
          ...
          <div className="flex flex-col justify-center space-y-6 md:space-y-12">
            {[
              { value: "7", label: "Модулей", sublabel: "Питание, тренировки, вода, сон, БЖУ, расписание, прогресс", direction: "right" },
              { value: "50к+", label: "Продуктов", sublabel: "В базе данных с возможностью сканирования", direction: "left" },
              { value: "100+", label: "Программ", sublabel: "Тренировок под любой уровень и цель", direction: "right" },
            ].map((stat, i) => {
